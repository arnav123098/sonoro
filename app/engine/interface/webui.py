...
class WebUI:
    def __init__(self, services, tools, make_client, data):
        ...
        self.app = Starlette(
            routes=[
                Mount("/characters", app=StaticFiles(directory=(data.characters_dir))),
                Mount("/animations", app=StaticFiles(directory=(data.animations_dir))),
